...
Mean difference needs to be put into context of the *spread (standard deviation)* and *sample size*. Recall the formula for the **sampling distribution of the mean:** $\normalsize \bar{X} \sim N(\mu, \sigma^2/n)$
