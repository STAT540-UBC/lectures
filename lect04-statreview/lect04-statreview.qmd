...
[1.  **Be familiar with the terminology**: describe data as random variables with various types of sampling distributions]{style="font-size: 1.5em;"}

[2.  **Gain intuition for the central concepts**: understand how statistical inference and modeling can help us learn about the properties of a population]{style="font-size: 1.5em;"}
:::
...
[**Variable**: an element, feature, or factor that is liable to vary or change]{style="font-size: 1.5em;"}
:::
...
[**Random Variable (RV)**: A variable whose value results from the measurement of a quantity that is subject to variation (e.g. the *outcome* an experiment)]{style="font-size: 1.5em;"}
:::
...
[**Probability**: A number assigned to an outcome/event that describes the extent to which it is likely to occur]{style="font-size: 1.5em;"}
:::
...
[**Probability distribution**: A mathematical function that maps outcomes/events to probabilities]{style="font-size: 1.5em;"}
:::
...
::: callout-note
[A **model** is a representation that (we hope) approximates the data and (more importantly) the population that the data were sampled from]{style="font-size: 1.5em;"}
:::
...
[If our analysis relies on the assumption that our observations are independent and they are not, our conclusions might be misleading]{style="font-size: 1.5em;"}
:::
...
::: callout-warning
[The standard deviation is not the same as the standard error]{style="font-size: 1.5em;"}
:::
