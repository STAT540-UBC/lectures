...
setwd("~/work/teaching/stat540/lectures/lect16-scRNAseq/")
library(data.table)
library(tidyverse)
library(patchwork)
library(matrixTests)
...
## Example: Pancreatic cells (Muraro _et al._ 2016)
...
```{r}
.file <- fig.dir %&% "/lect16_tSNE_raw_pca.rds"
...
if.needed(doublet.data,
{
    ...
    X.rnd <- read.sparse(qc.data$mtx, sub.cols = .rnd)
