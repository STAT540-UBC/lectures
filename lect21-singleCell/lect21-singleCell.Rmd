...
\Large
$$\mathcal{L} = \prod_{i=1}^{n}\prod_{g=1}^{\textsf{genes}} \left(\sum_{k} H_{ik} \beta_{kj}\right)^{X_{ij}}$$
}
...
\Large
$$\mathcal{L} = \prod_{i=1}^{n}\prod_{g=1}^{\textsf{genes}} \left(\underset{\textsf{\color{magenta} a gene $g$'s probability in a cell $ι$} \equiv \rho_{ig}}{\sum_{k} H_{ik} \beta_{kj}}\right)^{X_{ij}}$$
}
...
show.struct(etm.result$hh[[10]]) + ggtitle("epoch = " %&% (30*10))
```

```{r fig.width=5.5, fig.height=2, only.plot="2"}
show.struct(etm.result$hh[[20]]) + ggtitle("epoch = " %&% (30*20))
```

```{r fig.width=5.5, fig.height=2, only.plot="3"}
show.struct(etm.result$hh[[30]]) + ggtitle("epoch = " %&% (30*30))
```

```{r fig.width=5.5, fig.height=2, only.plot="4"}
show.struct(etm.result$hh[[40]]) + ggtitle("epoch = " %&% (30*40))
```
...
show.weight.matrix(etm.result$ww[[10]], .genes) + ggtitle("epoch = " %&% (30*10))
```

```{r fig.width=4.5, fig.height=3, only.plot="2"}
show.weight.matrix(etm.result$ww[[20]], .genes) + ggtitle("epoch = " %&% (30*20))
```

```{r fig.width=4.5, fig.height=3, only.plot="3"}
show.weight.matrix(etm.result$ww[[30]], .genes) + ggtitle("epoch = " %&% (30*30))
```

```{r fig.width=4.5, fig.height=3, only.plot="4"}
show.weight.matrix(etm.result$ww[[40]], .genes) + ggtitle("epoch = " %&% (30*40))
```
...
show.marker.correlation(etm.result$ww[[10]], .genes) + ggtitle("epoch = " %&% (30*10))
```

```{r fig.width=3, fig.height=3, only.plot="2"}
show.marker.correlation(etm.result$ww[[20]], .genes) + ggtitle("epoch = " %&% (30*20))
```

```{r fig.width=3, fig.height=3, only.plot="3"}
show.marker.correlation(etm.result$ww[[30]], .genes) + ggtitle("epoch = " %&% (30*30))
```

```{r fig.width=3, fig.height=3, only.plot="4"}
show.marker.correlation(etm.result$ww[[40]], .genes) + ggtitle("epoch = " %&% (30*40))
```
...
```{r fig.width=5.5, fig.height=2}
show.struct(last(etm.result$hh)) + ggtitle("epoch = " %&% (30*length(etm.result$hh)))
```
