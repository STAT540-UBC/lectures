...
* **Key idea 1**: heteroskedasticity leads to to higher variance observations getting more weight in minimization of error than they should
...
* Proposed by [Law et al. (2014)](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r29)
...
* Gene-specific variance under NB: $\sigma_g^2 = \mu_g + \mu_g^2\phi_g),$ where $\phi_g$ is the **dispersion** for gene $g$
