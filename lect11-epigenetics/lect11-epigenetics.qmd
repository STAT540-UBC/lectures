...
* Explain the main similarities and differences (and understand their implications) between analysis of **differential expression** and **differential methylation**:
...
Recall basics of DNA methylation and DNA-binding assays from [lecture 2](https://github.com/STAT540-UBC/lectures/raw/main/lect02-technology.pdf)
...
::: columns
:::{.column width=75%}
![](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8353442/bin/fgene-12-671057-g004.jpg){fig-align="center"}
:::
:::{.column width=25%}
We'll focus on two common approaches for distinguishing methylated and unmethylated sites: 

1. Affinity enrichment
2. Bisulfite conversion

[image: Barefoot et al., 2021](https://doi.org/10.3389%2Ffgene.2021.671057)
:::
:::

##  Affinity enrichment: basics

::: columns
::: column

* example: Methylated DNA immunoprecipitation (MeDIP)
* targets **only** methylated DNA - the 'methylome'
...
* **MeDIP-seq**: 
  * differential abundance of counts (similar to RNA-seq)
...
##  Bisulfite conversion: arrays (e.g. Infinium 450K, Epic 850K)
...
![[image source](https://doi.org/10.2144/000114133)](https://www.researchgate.net/publication/260119313/figure/fig4/AS:380764744110083@1467792797223/ChIP-seq-procedure-for-detecting-sequences-at-the-sites-of-histone-modifications-or-the.png)
