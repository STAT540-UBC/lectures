...
```{r results="asis", out.width=".8\\linewidth", echo = FALSE}
...
```{r fig.width=1, fig.height=2.5, echo=FALSE, only.plot="1"}
x.sub <- X[1:100, , drop = FALSE]
.matshow(x.sub, .scale=TRUE, .lab=0, .size=0)
```

```{r fig.width=1, fig.height=2.5, echo=FALSE, only.plot="2"}
...
```{r fig.width=1, fig.height=2.5, echo=FALSE}
x.sub <- X[1:100, , drop = FALSE]
.matshow(x.sub, .scale=TRUE, .lab=0, .size=0)
```
...
```{r fig.width=2, fig.height=2.5, echo=FALSE, onslide.plot="1-"}
x.sub <- t(scale(t(log(1 + X[1:100, , drop = FALSE]))))
.matshow(x.sub, .scale=TRUE, .lab=0, .size=0) +
...
```{r fig.width=2, fig.height=2.5, echo=FALSE, onslide.plot="2"}
...
`r var.exp*100`% variance explained
...
```{r fig.width = 5, fig.height = 2, only.plot = 1, echo = FALSE}
tt <- 1
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 2, echo = FALSE}
tt <- 2
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 3, echo = FALSE}
tt <- 3
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 4, echo = FALSE}
tt <- 4
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 5, echo = FALSE}
tt <- 5
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 6, echo = FALSE}
tt <- 10
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 7, echo = FALSE}
tt <- 20
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 8, echo = FALSE}
tt <- 25
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 9, echo = FALSE}
tt <- 30
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 10, echo = FALSE}
tt <- 40
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```

```{r fig.width = 5, fig.height = 2, only.plot = 11, echo = FALSE}
tt <- 100
show.z.trace(Z.trace, tt) | show.mu.trace(mu.trace, tt)
```
...
```{r results="asis", out.width=".5\\linewidth", echo = FALSE}
...
```{r results="asis", out.width=".45\\linewidth", echo = FALSE}
knitr::include_graphics("./Vis/unsupervised/GMM_graphical_model.pdf")
```
