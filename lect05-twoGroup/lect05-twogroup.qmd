...
* [Project Proposal Lightning Talks](https://stat540-ubc.github.io/group_project_rubrics.html#project-proposal-lightning-talks-5-pts) in class Tuesday Jan 31 (Slides due Monday Jan 30 11:59pm)
...
[Is the expression level of gene *A* affected by knockout of the *Nrl* gene?]{style="font-size: 1.5em;"}
:::
...
[1. Is the expression level of gene *Irs4* truly different in NrlKO compared to WT?]{style="font-size: 1.5em;"}

[2. Is the expression level of gene *Nrl* truly different in NrlKO compared to WT?]{style="font-size: 1.5em;"}
:::
...
[But how can we calculate population variance $\sigma$ if it is **unknown**?]{style="font-size: 1.5em;"}
:::
...
::: callout-note
# Definition
[**p-value**: Probability of observing a test statistic at least as extreme as that observed, under the *null sampling distribution*]{style="font-size: 1.5em;"} 
:::
...
[What if we aren't comfortable assuming the underlying data generating process is normal **AND** we aren't sure our sample is large enough to invoke the CLT?]{style="font-size: 1.5em;"}
:::
...
3. What should you do if methods that are equally appropriate and defensible give very different answers?
