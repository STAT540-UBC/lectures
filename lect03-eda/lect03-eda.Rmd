...
- These slides were made using [this R Markdown file](https://github.com/STAT540-UBC/lectures/blob/main/lec03-eda/lec03-eda.Rmd); it contains the code used to generate the R plots shown here
