...
* **Issues with the livestream?**: [Post here](https://github.com/STAT540-UBC-2022/Discussion/issues/26)

* **Midterm survey**: Link posted in [Discussion repo](https://github.com/STAT540-UBC-2022/Discussion/issues/25)
...
* **Projects**: feedback from your project mentors is posted on your initial project proposals (see the issue in your team's repository) 
  ...
  * reminder: finalized proposals due Friday
  
* Reminder that the **paper critique** is due today
