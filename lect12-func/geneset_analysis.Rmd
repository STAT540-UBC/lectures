...
## Under null of hypergeometric distribution
...
## *Review of binomial coefficient*: Let's see if we can estimate null distribution by counting
...
\begin{array}{l}
  ...
  \textsf{of having a set w/size }k \\
  \textsf{out of }N
\end{array}} \\
&=&
\onslide<2->{
